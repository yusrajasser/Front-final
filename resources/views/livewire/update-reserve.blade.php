<div>
    ...
    <form method="POST" class="d-flex flex-column justify-content-center align-items-center" dir="rtl" id="reserve_form">
        @csrf
        <h1 class="h3 mb-3 fw-normal p-5 rounded"> تحديث حجز</h1>
        <input type="hidden" id="reserve_id" value="{{ $data['reserve']['id'] }}">

        <div class="w-100 d-flex justify-content-center gap-1 col-6 pt-2">
            <div class="form-row p-1 rounded col-6">
                <label class="col-sm-4" for="name">الوجهة</label>
                <select name="ride_id" wire:model="selectRide" class="form-control" id="from-to">
        ...
        <div class="form-row p-1 rounded col-6">
            ...
            <div class="d-flex">
                <select class="form-control" name="status">
                    <option value="" readonly>إختر الحالة</option>
        ...
        <div class="d-flex flex-justify-center pt-5 pb-5">
            <button class="w-100 btn btn-lg btn-primary" id="submitBtn" type="button">تحديث</button>
