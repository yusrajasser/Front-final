...
@section('title')
    <title>لوحة التحكم | طلبات السائقين</title>
@endsection
                    ...
                    <tr>
                        <td>
                            <div class="d-flex flex-column justify-content-start align-items-start">
                                <a href="{{ route('driver.show', $value['id']) }}">
                                    <div class="h5">{{ $value['name'] }}</div>
                                </a>
                                <div class="">
                                    <img src="{{ asset("storage/$value[driver_license]") ?? '' }}"
                                        style="fit-object:cover;" width="120" height="60">
                                </div>
                            </div>
