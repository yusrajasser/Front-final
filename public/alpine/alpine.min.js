(() => {
    ...
    function Be(e) {
        return new Proxy(
            ...
            {
                ownKeys: () =>
                    Array.from(new Set(e.flatMap((t) => Object.keys(t)))),
...
`,
    ...
    function Wn(e, t) {
        ...
        if (r.includes("debounce")) {
            ...
            r.splice(
                o,
                pt((r[o + 1] || "invalid-wait").split("ms")[0]) ? 2 : 1
            );
        }
        ...
        r((s) => {
            ...
            if (i(s))
                s = Object.entries(s).map(([f, _]) => {
                    let y = Cr(t, _, f, s);
                    n((C) => u.push(C), { scope: { index: f, ...y } }),
                        l.push(y);
                });
            else
                for (let f = 0; f < s.length; f++) {
                    let _ = Cr(t, s[f], f, s);
                    n((y) => u.push(y), { scope: { index: f, ..._ } }),
                        l.push(_);
                }
            let d = [],
                E = [],
